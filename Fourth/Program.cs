// 4. Реализуйте алгоритмы сети Фейстеля (шифрование и дешифрование):
// - для языков, поддерживающих ООП: в виде класса FeistelNet с
// 	абстрактными функциями для генерации подключей и шифрующего
// преобразования (примените паттерн проектирования “Шаблонный
// метод”);
